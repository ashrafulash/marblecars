    ...
    function DateTimePicker(element, options) {
        var picker = {},
            ...
            _createDatePicker = function () {
                ...
                $table.$prevm = _createCell($row, '<i class="fas fa-arrow-left"></i>', 1, NAV['prevm'], "prevm");
                //head - tools - title
                $table.$title = $('<td class="title" colspan="5"/>').data('nav', NAV['title']).appendTo($row);
                //head - tools - prev month
                $table.$nextm = _createCell($row, '<i class="fas fa-arrow-right"></i>', 1, NAV['nextm'], "nextm");
                $row.appendTo($thead);
                //head - week names
                $row = $('<tr/>');
                var i;
            ...
            _createMonthPicker = function () {
                ...
                //tbody - 翻年按钮
                _createCell($row, '<i class="fas fa-arrow-left"></i>', 1, NAV['prevy'], ' prevy');
                _createCell($row, '<i class="fas fa-arrow-right"></i>', 1, NAV['nexty'], ' nexty');
                //tbody - years
                for (var m = 0; m < 5; m++) {
